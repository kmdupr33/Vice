...
public class ByteBuddyRecordingObjectFactory implements RecordingObjectFactory {
    ...
    public ListRecordingObject make(Class classToClamp) throws InstantiationException, IllegalAccessException {
        ...
        final Object rawObject = clampedClassTypeDef
                ...
                .getLoaded()
                .newInstance();
        return new ListRecordingObject(rawObject, invocations);
    }
    ...
    private static class ListRecordingObject implements RecordingObject {
        private final Object rawObject;
        private final List<Triple<Method, List<Object>, Object>> args;

        private ListRecordingObject(Object rawObject, List<Triple<Method, List<Object>, Object>> args) {
